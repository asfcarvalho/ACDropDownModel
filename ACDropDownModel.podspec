...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ACDropDownModel.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/asfcarvalho@me.com/ACDropDownModel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'asfcarvalho@me.com' => 'asfcarvalho@me.com' }
  s.source           = { :git => 'https://github.com/asfcarvalho@me.com/ACDropDownModel.git', :tag => s.version.to_s }
